package com.runehub.game.util;

/**
 * @author Tylurr <tylerjameshurst@gmail.com>
 * Exact same as {@link java.util.concurrent.TimeUnit} with the addition of support for the 600ms game tick.
 */
public enum TickUnit {
    ...
    NANOSECONDS {
        ...
        public long convert(long d, TickUnit u) {
            return u.toNanos(d);
        }
    ...
    /**
     * Time unit representing one game tick (600 milliseconds)
     */
    GAMETICKS {
        public long toNanos(long d) {
            return d * 600000000;
     ...
     */
    public long convert(long sourceDuration, TickUnit sourceUnit) {
        throw new AbstractMethodError();
    }

    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) NANOSECONDS.convert(duration, this)}.
     *
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) MICROSECONDS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) MILLISECONDS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) SECONDS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) MINUTES.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) HOURS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration,
     * or {@code Long.MIN_VALUE} if conversion would negatively
    ...
    /**
     * Equivalent to
     * {@link #convert(long, TickUnit) DAYS.convert(duration, this)}.
     *
     * @param duration the duration
     * @return the converted duration
     * @since 1.6
